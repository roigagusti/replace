...
function actData(){
	...
	window.location.replace('http://app.cuantime.com/fitxatges.php?date='+mes+'-'+res[1]);
}
...
if (window.navigator.userAgent.indexOf('iPhone') != -1) {
  if (window.navigator.standalone == true) {
    $("div.simpleLayout").addClass("webApp-offset");
    $("div.modal-dialog").addClass("webApp-offset");
    $("ul.metismenu").addClass("webApp-offset");
  }
}