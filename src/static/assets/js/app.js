! function(a) {
    ...
    a("#side-menu").metisMenu(), a(".vertical-menu-btn").on("click", function(e) {
            ...
            this.href == e && (a(this).addClass("active2"), a(this).parent().addClass("mm-active2"), a(this).parent().parent().addClass("mm-show2"), a(this).parent().parent().prev().addClass("mm-active2"), a(this).parent().parent().parent().addClass("mm-active2"), a(this).parent().parent().parent().parent().addClass("mm-show2"), a(this).parent().parent().parent().parent().parent().addClass("mm-active2"))
